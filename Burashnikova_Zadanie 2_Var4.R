###Бурашнинова Екатерина - создайте модель множественной линейной регрессии потоков
###паров воды за осенний период 2013 
###года по данным измерений методом турбулентной пульсации
library("tidyverse") # целая вселенная
library("readr") # функция read_csv()
library("stringr") # фукция str_replace_all
library("dplyr") # фукции: Filter (); arrange_ (); select (); mutate (); summary (); group_by_n()
